...
import tech1 from "../assets/day4/tech1.jpg";
import tech2 from "../assets/day4/tech2.jpg";
import tech3 from "../assets/day4/tech3.jpg";
import tech4 from "../assets/day4/tech4.jpg";
...
<div className="intro-text" style={{ width:'70%' }}>
  <p>Today was unexpectedly wild in the nerdiest, most fascinating way. We kicked things off at the Bangko Sentral ng Pilipinas factory, where we got to witness the entire production process of our very own peso bills. From design layout to the actual printing of money, it was hypnotic. The place is locked down tighter than a K-pop idol’s dating life, so yeah, no photos allowed. But honestly, what made the experience even better was our tour guide. I forgot her first name (tragic), but her ID said “Miss Aquino,” and she mentioned being a UP grad. Every time she spoke, I swear I caught myself simping. Smart, gorgeous, and composed, a dangerous combo.
<br></br> <br></br>
Next up was Hytec Power Inc., and it felt like we just teleported into a futuristic tech lab. There were all sorts of robotic inventions—like remote-controlled cars with little robot arms (no clue what they’re actually called, but they were sick). The craziest part? They offer programming classes to 5-year-olds. Like, what?? Meanwhile, I was still trying to figure out which crayon tasted the best at that age.</p>
</div>
...
<a href="#modal5" className="card1" style={{ visibility: 'hidden' }}>
  <div className="card1__img">  
  <img src={museum10} />  
    <div className="card1__overlay">
    </div>
...
<img src={tech4} className="modal-content"/> 
</div>


<div id="modal2" className="modal">
<a href="#" className="modal-close">&times;</a>
<img src={tech2}  className="modal-content"/>  
</div>

<div id="modal3" className="modal">
<a href="#" className="modal-close">&times;</a>
<img src={tech1}   className="modal-content"/> 
</div>

<div id="modal4" className="modal">
<a href="#" className="modal-close">&times;</a>
<img src={tech3}     className="modal-content"/> 
</div>
